...
const AllServices = () => {
  ...
  return (
    <div>
      <div className="text-2xl text-center font-bold"> Our Populars Services</div>
      <p className=" text-center ">Explore Our Premium services.</p>
     
     <form onSubmit={handleSearch} className=" mt-5 mb-10 flex gap-3 justify-center px-5">
